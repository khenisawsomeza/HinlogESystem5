...
import static com.mycompany.hinlogesystem.HinlogESystem.con;
...
public class Login extends javax.swing.JFrame {
    ...
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginBtnActionPerformed
       ...
       try {
           ...
           System.out.println("Inavalid Login: " + ex);
           dataInput.removeAllItems();
           submitBtn.setEnabled(false);
           dataInput.setEnabled(false);
       }
    ...
    private void submitBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitBtnActionPerformed
        ...
        if ((String)dataInput.getSelectedItem() == null){
            ...
            database = (String)dataInput.getSelectedItem();
        }
        ...
        if (username.equals("root")) {
               ...
               system.db = database;
               system.DBConnect();
               StudRegistration reg = new StudRegistration();
               reg.setVisible(true);
